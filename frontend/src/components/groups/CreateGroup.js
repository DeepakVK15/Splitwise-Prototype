...
class CreateGroup extends Component {
    ...
    render() { 
        ...
        if(this.state.errCode === "inserted group."){
        ...
        return (
          ...
          <form class="creategroupform">
            <div class="intro">
              ...
              <input type="file" className='image' accept=".jpg,.jpeg,.png,.svg" onChange={this.imageHandler} />
                <br /><br/>
              <label class="font-weight-normal">My group shall be called: </label>
              <br />
              <input type="text" id="groupname" onChange={this.groupnameHandler} placeholder="Group name" />
              <br />
              <br />
              ...
              <br/>
              <button type="button" class="createGroup" onClick={this.createGroup}>
              Save
            </button>
